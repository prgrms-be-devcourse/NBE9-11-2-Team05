...
import com.team05.demo.domain.user.dto.profile.MyProfileDetailRes;
import com.team05.demo.domain.user.dto.profile.UserCheerAnimalRes;
import com.team05.demo.domain.user.dto.profile.UserFeedRes;
import com.team05.demo.domain.user.dto.profile.UserProfileRes;
...
public class UserProfileService {
    ...
    public void modifyPassword(Long userId, @NotBlank(message = "현재 비밀번호를 입력해주세요.") String currentPassword, @NotBlank(message = "새 비밀번호를 입력해주세요.") String newPassword) {
        User user = getUserById(userId);

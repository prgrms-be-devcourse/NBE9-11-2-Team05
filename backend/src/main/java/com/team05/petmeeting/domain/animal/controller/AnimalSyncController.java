...
public class AnimalSyncController {
    ...
    @PostMapping("/sync")
    public ResponseEntity<AnimalSyncService.SyncResult> syncAnimals(
    ...
    public ResponseEntity<AnimalSyncService.SyncResult> syncMonthlyFrom2008(
    ...
    public ResponseEntity<AnimalSyncService.SyncResult> syncByUpdatedDate(
            @RequestParam(defaultValue = "500") int numOfRows
    ) {
